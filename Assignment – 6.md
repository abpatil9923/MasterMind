...
mysql> select * from customers where Cname <= 'H%';
...
SELECT * FROM customers WHERE left(cname,1) in("a","b","c","d","e","f","g");
+------+----------+----------+--------+------+
| Cnum | Cname    | City     | Rating | Snum |
+------+----------+----------+--------+------+
| 2002 | Giovanni | Rome     |    200 | 1003 |
...
select * from customers  where left(Cname,1) = "C";
+------+----------+----------+--------+------+
| Cnum | Cname    | City     | Rating | Snum |
+------+----------+----------+--------+------+
| 2006 | Clemens  | London   |    100 | 1001 |
...
select * from orders where amt NOT NULL;
